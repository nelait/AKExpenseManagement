...
<head>
    ...
    <title>Project Estimation Report - Expense Management System.</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p><strong>Project:</strong> Expense Management System.</p>
            <p class="date">Generated: 2/20/2026</p>
        ...
        <div class="summary-grid">
            ...
            <div class="summary-card">
                ...
                <div class="metric-value">4300</div>
                <p>Development Hours</p>
            </div>
            <div class="summary-card">
                <h3>Project Cost</h3>
                <div class="metric-value">$322,500</div>
        ...
        <div class="summary-card">
            ...
            <table style="margin: 10px 0;">
                ...
                <tbody>
                    <tr><td>Add Expense</td><td>Form to enter expense details</td><td>8</td><td>Average</td><td>Moderate validation required</td></tr>
                    <tr><td>Edit Expense</td><td>Form to update existing expense</td><td>8</td><td>Average</td><td>Similar to Add Expense</td></tr>
                    <tr><td>Delete Expense</td><td>Endpoint to remove an expense</td><td>3</td><td>Simple</td><td>Minimal validation</td></tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="summary-card">
            ...
            <table style="margin: 10px 0;">
                ...
                <tbody>
                    <tr><td>Monthly Expense Report</td><td>Report summarizing expenses by month</td><td>25</td><td>Complex</td><td>Multiple calculations and formats</td></tr>
                    <tr><td>Category Breakdown</td><td>Report showing expenses by category</td><td>15</td><td>Average</td><td>Moderate calculations</td></tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="summary-card">
            ...
            <table style="margin: 10px 0;">
                ...
                <tbody>
                    <tr><td>Search Expenses</td><td>Search expenses by date, category, and amount</td><td>10</td><td>Average</td><td>Moderate filtering required</td></tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="summary-card">
            ...
            <table style="margin: 10px 0;">
                ...
                <tbody>
                    <tr><td>Expenses</td><td>Stores all expense records</td><td>30</td><td>3</td><td>Average</td><td>Multiple record types</td></tr>
                    <tr><td>Categories</td><td>Stores expense categories</td><td>10</td><td>1</td><td>Simple</td><td>Single record type</td></tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="summary-card">
            ...
            <table style="margin: 10px 0;">
                ...
                <tbody>
                    <tr><td>Bank API</td><td>Integration with banking API for transactions</td><td>25</td><td>API</td><td>Average</td><td>Moderate integration complexity</td></tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="metric-box">
            <div class="metric-value">TCF = 1.20</div>
            <p>Based on 14 environmental factors</p>
        </div>

        <h3>Adjusted Function Points (AFP)</h3>
        <div class="metric-box">
            <div class="metric-value">AFP = 51 × 1.20 = 61</div>
        ...
        <div class="summary-grid">
            <div class="summary-card">
                <h4>Optimistic (-15%)</h4>
                <div class="metric-value">$313,225</div>
            </div>
            <div class="summary-card">
                <h4>Most Likely</h4>
                <div class="metric-value">$368,500</div>
            </div>
            <div class="summary-card">
                <h4>Pessimistic (+25%)</h4>
                <div class="metric-value">$460,625</div>
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>Regular technical reviews</td>
                </tr>
                <tr>
                    ...
                    <td>Strict change management</td>
                </tr>
                <tr>
                    ...
                    <td>Resource backup planning</td>
                </tr>
                <tr>
                    ...
                    <td>Medium</td>
                    <td><span class="risk-medium">Medium</span></td>
                    <td>Prototyping and testing phases</td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="summary-grid">
            <div class="summary-card">
                ...
                <p>Based on detailed requirements gathering and stakeholder input</p>
            </div>
            <div class="summary-card">
                <h4>Key Assumptions</h4>
                <ul>
                    <li>Stable requirements post-freeze</li>
                    <li>Availability of skilled resources</li>
                    <li>Standard technology stack use</li>
                </ul>
            </div>
        </div>
...
This HTML document provides a complete project estimation using the Function Point Analysis methodology. Adjustments to the numbers and assumptions should be made based on real project data and requirements.